...
function PreloadAudioFiles() {
    audioBlobs.Alert = { file: "Alert.mp3", url: hostingPrefex + "../SIPML5Content/media/Alert.mp3" }
    audioBlobs.Ringtone = { file: "Ringtone_1.mp3", url: hostingPrefex + "../SIPML5Content/media/Ringtone_1.mp3" }
    audioBlobs.speech_orig = { file: "speech_orig.mp3", url: hostingPrefex + "../SIPML5Content/media/speech_orig.mp3" }
    audioBlobs.Busy_UK = { file: "Tone_Busy-UK.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_Busy-UK.mp3" }
    audioBlobs.Busy_US = { file: "Tone_Busy-US.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_Busy-US.mp3" }
    audioBlobs.CallWaiting = { file: "Tone_CallWaiting.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_CallWaiting.mp3" }
    audioBlobs.Congestion_UK = { file: "Tone_Congestion-UK.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_Congestion-UK.mp3" }
    audioBlobs.Congestion_US = { file: "Tone_Congestion-US.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_Congestion-US.mp3" }
    audioBlobs.EarlyMedia_Australia = { file: "Tone_EarlyMedia-Australia.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_EarlyMedia-Australia.mp3" }
    audioBlobs.EarlyMedia_European = { file: "Tone_EarlyMedia-European.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_EarlyMedia-European.mp3" }
    audioBlobs.EarlyMedia_Japan = { file: "Tone_EarlyMedia-Japan.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_EarlyMedia-Japan.mp3" }
    audioBlobs.EarlyMedia_UK = { file: "Tone_EarlyMedia-UK.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_EarlyMedia-UK.mp3" }
    audioBlobs.EarlyMedia_US = { file: "Tone_EarlyMedia-US.mp3", url: hostingPrefex + "../SIPML5Content/media/Tone_EarlyMedia-US.mp3" }
...
function AddLineHtml(lineObj) {
    ...
    html += "</td></tr>";
    html += "<tr><td class=\"streamSection streamSectionBackground\" style=\"background-image:url('" + hostingPrefex + "../SIPML5Content/wp_1.png')\">";
